...
import { PromptpayTopupForm } from "@/components/topup/promptpay-topup-form"
import { TopupHistoryPanel } from "@/components/topup/topup-history-panel"

export default function TopupPromptpayPage() {
  ...
  return (
    <TopupPageShell backHref="/topup" backLabel="เลือกช่องทางอื่น" toast={toast}>
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <PromptpayTopupForm onSuccess={handleSuccess} />
